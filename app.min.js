    ...
    $(function() {
        ...
        class AppController {
            ...
            setupEventListeners() {
                ...
                // File inputs
                this.fileInput.addEventListener('change', e => e.target.files[0] && this.loadVideo(e.target.files[0]));
                this.jsonInput.addEventListener('change', e => e.target.files[0] && this.handleJSONImport(e.target.files[0]));
                this.subtitleFileInput.addEventListener('change', e => this.handleSubtitleSelect(e));
        ...
        // Set up video focus handling
        app.video.addEventListener('play', function() {
            app.video.focus();
        });
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Tab' && !app.video.paused) {
                e.preventDefault();
            }
        });
        
        console.log('Optimized Supercut and Marker Video Editor initialized successfully!');
    });
});